...
const PostModel = (props) => {
  ...
  const handlePostArticles = (e)=>{
    ...
    props.    postArticles:(payload)=>dispatch(postArticleAPI(payload))
    (payload)
    reset(e);
  }
    ...
    return (
      <Container>
        <Content>
          <Header>
            <h2>Create a post</h2>
            <button onClick={(e) => reset(e.target.value)}>
          ...
          <ShareCreation>
            ...
            <PostButton onClick={(e)=>handlePostArticles(e)} disabled={!editorText ? true : false}>Post</PostButton>
          </ShareCreation>
        </Content>
      </Container>
    );
